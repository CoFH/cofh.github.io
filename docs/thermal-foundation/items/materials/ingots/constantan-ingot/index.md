...
**Constantan ingots** are raw materials made from
...
Constantan can be obtained by combining
[copper](/docs/thermal-foundation/items/materials/ingots/copper-ingot) and
[nickel](/docs/thermal-foundation/items/materials/ingots/nickel-ingot/), either
by crafting [constantan
blend](/docs/thermal-foundation/items/materials/dusts/constantan-blend/) or by
using an [induction
