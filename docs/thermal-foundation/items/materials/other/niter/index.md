...
rods](/docs/thermal-foundation/items/materials/elemental/blitz-rod/) in a
[pulverizer](/docs/thermal-expansion/machines/pulverizer/). It can be used to
...
[aerotheum
dust](/docs/thermal-foundation/items/materials/elemental/aerotheum-dust/) and
...
### Blitzes
A [blitz](/docs/thermal-foundation/world/mobs/blitz/) may drop up to two pieces
of niter when killed by a player.
