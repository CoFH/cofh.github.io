...
insolator](/docs/thermal-expansion/machines/phytogenic-insolator/). It can also
be used to craft [podzol](https://minecraft.gamepedia.com/Podzol) and
[mycelium](https://minecraft.gamepedia.com/Mycelium). It is stronger than
[regular Phyto-Gro](/docs/thermal-foundation/items/materials/other/phyto-gro/),
but weaker than [fluxed
Phyto-Gro](/docs/thermal-foundation/items/materials/other/fluxed-phyto-gro/).
