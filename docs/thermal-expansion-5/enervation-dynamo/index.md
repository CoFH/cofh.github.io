...
An **enervation dynamo** is a [dynamo](/docs/thermal-expansion-5/dynamos/) that extracts [Redstone
...
An enervation dynamo can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
