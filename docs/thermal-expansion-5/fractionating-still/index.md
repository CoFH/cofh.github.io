...
is a [machine](/docs/thermal-expansion-5/machines/) that refines fluids.
...
A fractionating still can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
