...
A **compactor** is a [machine](/docs/thermal-expansion-5/machines/) that applies pressure to items
...
A compactor can have [augments](/docs/thermal-expansion-5/augments/) installed to improve certain
