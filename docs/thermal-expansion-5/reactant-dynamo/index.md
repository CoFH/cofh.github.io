...
A **reactant dynamo** is a [dynamo](/docs/thermal-expansion-5/dynamos/) fueled by fluid fuel and
solid reactant.
...
A reactant dynamo can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
