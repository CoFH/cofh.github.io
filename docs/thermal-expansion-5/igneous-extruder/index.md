...
[machine](/docs/thermal-expansion-5/machines/) that mixes hot and cold fluids to create items.
...
An igneous extruder can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
