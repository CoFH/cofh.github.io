...
A **redstone furnace** is a [machine](/docs/thermal-expansion-5/machines/) that
...
When installed, [pyrolytic conversion](/docs/thermal-expansion-5/augment-pyrolytic-conversion/)
...
A redstone furnace can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
