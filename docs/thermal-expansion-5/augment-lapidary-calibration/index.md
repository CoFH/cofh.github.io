...
A **lapidary calibration** [augment](/docs/thermal-expansion-5/augments/) allows for a [numismatic
dynamo](/docs/thermal-expansion-5/numismatic-dynamo/) to use various [gemstones](#fuels) as fuel,
...
[numismatic dynamo](/docs/thermal-expansion-5/numismatic-dynamo/)'s GUI. It is a specialization that
cannot be installed together with other specialization augments.

### Effects
An installed lapidary calibration augment allows for a [numismatic
dynamo](/docs/thermal-expansion-5/numismatic-dynamo/) to use various [gemstones](#fuels) as fuel. It
...
dynamo](/docs/thermal-expansion-5/numismatic-dynamo/) with a lapidary calibration augment installed.
