...
A **magmatic dynamo** is a [dynamo](/docs/thermal-expansion-5/dynamos/) fueled by hot fluids like
...
A magmatic dynamo can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
