...
A **pulverizer** is a [machine](/docs/thermal-expansion-5/machines/) that crushes items. It is
...
When installed, a [tectonic initiator](/docs/thermal-expansion-5/augment-tectonic-initiator/) allows
...
A pulverizer can have [augments](/docs/thermal-expansion-5/augments/) installed to improve certain
