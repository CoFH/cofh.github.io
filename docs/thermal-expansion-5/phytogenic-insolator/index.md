...
[machine](/docs/thermal-expansion-5/machines/) that grows and multiplies plants using
...
A phytogenic insolator can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
