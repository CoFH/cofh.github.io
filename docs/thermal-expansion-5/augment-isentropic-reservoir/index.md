...
An **isentropic reservoir** is an [augment](/docs/thermal-expansion-5/augments/) that increases the
amount of [Redstone Flux](/docs/redstone-flux/) a [magmatic
dynamo](/docs/thermal-expansion-5/magmatic-dynamo/) generates by making it consume
[coolant](/docs/thermal-expansion-5/coolants/) as well as fuel.
...
dynamo](/docs/thermal-expansion-5/magmatic-dynamo/)'s GUI. It is a specialization that cannot be
installed together with other specialization augments.

### Effects
An installed isentropic reservoir quadruples the maximum power output of a
[magmatic dynamo](/docs/thermal-expansion-5/magmatic-dynamo/), and increases the amount of [Redstone
Flux](/docs/redstone-flux/) it generates from each unit of fuel by 15%. However,
the dynamo requires [coolant](/docs/thermal-expansion-5/coolants/) as well as fuel to generate
energy.
