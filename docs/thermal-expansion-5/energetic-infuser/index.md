...
[machine](/docs/thermal-expansion-5/machines/) that charges items with [Redstone
...
augment](/docs/thermal-expansion-5/augment-flux-reconstruction/) allows an energetic infuser to
...
An energetic infuser can have [augments](/docs/thermal-expansion-5/augments/) installed to improve
