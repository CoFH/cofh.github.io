...
[machine](/docs/thermal-expansion/machines/) that smelts items together at high
temperatures. Despite the name, the machine cannot be used for
...
allows an induction smelter to consume [blazing
pyrotheum](/docs/thermal-foundation/fluids/elemental/blazing-pyrotheum/), which
...
sand](https://minecraft.gamepedia.com/Soul_Sand), [rich
slag](/docs/thermal-foundation/items/materials/other/rich-slag/) or
[cinnabar](/docs/thermal-foundation/items/materials/other/cinnabar/). These
items are commonly used in smelter recipes.
...
Induction smelters come in six [tiers](/docs/thermal-expansion/tiers/).
...
An induction smelter can have [augments](/docs/thermal-expansion/augments/)
