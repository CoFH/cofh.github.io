...
A **magma crucible**, or **crucible** for short, is a
[machine](/docs/thermal-expansion/machines/) that melts items into fluids.
...
### Redprints
A magma crucible's configuration can be saved on a
...
Magma crucibles come in six [tiers](/docs/thermal-expansion/tiers/).
...
A magma crucible can have [augments](/docs/thermal-expansion/augments/)
installed to improve certain properties or to change how it works. Augments can
be installed in the Augmentation tab in a crucible's GUI.
