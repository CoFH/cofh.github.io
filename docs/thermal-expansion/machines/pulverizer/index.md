...
A **pulverizer** is a [machine](/docs/thermal-expansion/machines/) that crushes
items. It is commonly used to process ores and other items more efficiently, and
to recycle certain items.
...
When installed, a [tectonic
initiator](/docs/thermal-expansion/augments/machine/tectonic-initiator/) allows
a pulverizer to consume [tectonic
petrotheum](/docs/thermal-foundation/fluids/elemental/tectonic-petrotheum/),
...
Pulverizers come in six [tiers](/docs/thermal-expansion/tiers/).
...
A pulverizer can have [augments](/docs/thermal-expansion/augments/) installed to
improve certain properties or to change how it works. Augments can be installed
in the Augmentation tab in a pulverizer's GUI.
