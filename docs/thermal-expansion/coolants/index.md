...
Coolants are used by [compression dynamos](/docs/thermal-expansion/compression-dynamo/), [magmatic
dynamos](/docs/thermal-expansion/magmatic-dynamo/) with [isentropic
reservoirs](/docs/thermal-expansion/augment-isentropic-reservoir/) installed and [thermal
mediators](/docs/thermal-expansion/thermal-mediator/).
