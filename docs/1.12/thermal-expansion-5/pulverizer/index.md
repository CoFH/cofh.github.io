...
A **pulverizer** is a [machine](/docs/1.12/thermal-expansion-5/machines/) that crushes items. It is
...
When installed, a [tectonic initiator](/docs/1.12/thermal-expansion-5/augment-tectonic-initiator/) allows
a pulverizer to consume [tectonic petrotheum](/docs/1.12/thermal-foundation-2/tectonic-petrotheum/), which
...
### Security
A pulverizer can have a [signalum security lock](/docs/1.12/thermal-foundation-2/signalum-security-lock/)
installed to restrict who can access it.

### Redprints
A pulverizer's configuration can be saved on a [redprint](/docs/1.12/thermal-foundation-2/redprint/) to be
...
Pulverizers come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
A pulverizer can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve certain
