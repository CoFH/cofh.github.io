...
[machine](/docs/1.12/thermal-expansion-5/machines/) that smelts items together at high temperatures.
...
When installed, a [pyro-concentrator](/docs/1.12/thermal-expansion-5/augment-pyro-concentrator/) allows
an induction smelter to consume [blazing pyrotheum](/docs/1.12/thermal-foundation-2/blazing-pyrotheum/),
...
and [cinnabar](/docs/1.12/thermal-foundation-2/cinnabar/). These items are commonly used in smelter
...
[redprint](/docs/1.12/thermal-foundation-2/redprint/) to be copied to other induction smelters.
...
Induction smelters come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
An induction smelter can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve
