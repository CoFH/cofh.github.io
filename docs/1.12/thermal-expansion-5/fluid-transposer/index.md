...
[machine](/docs/1.12/thermal-expansion-5/machines/) that fills and empties items that hold fluids, like
...
### Redprints
A fluid transposer's configuration can be saved on a [redprint](/docs/1.12/thermal-foundation-2/redprint/)
...
Fluid transposers come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
A fluid transposer can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve
...
* [Glass bottles](https://minecraft.gamepedia.com/Glass_Bottle) can be filled
  with [fluid potions](/docs/1.12/thermal-foundation-2/potion-fluid/) (250 mB each) for 800 RF.
...
* 250 mB of a [fluid potion](/docs/1.12/thermal-foundation-2/potion-fluid/) can be drained from a
