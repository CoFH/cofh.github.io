...
[machine](/docs/1.12/thermal-expansion-5/machines/) that separates items into their components.
...
[redprint](/docs/1.12/thermal-foundation-2/redprint/) to be copied to other centrifuges.
...
Centrifugal separators come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
A centrifugal separator can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to
