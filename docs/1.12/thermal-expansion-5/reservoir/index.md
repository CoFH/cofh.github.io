...
transposer](/docs/1.12/thermal-expansion-5/fluid-transposer/) or similar. It can be filled and drained at
...
### Enchantments
A reservoir can be enchanted with [Holding](/docs/1.12/cofh-core-4/holding/) to increase its
capacity.
...
Reservoirs come in six [tiers](/docs/1.12/thermal-foundation-2/tiers/).
