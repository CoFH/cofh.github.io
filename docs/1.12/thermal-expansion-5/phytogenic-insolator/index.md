...
[machine](/docs/1.12/thermal-expansion-5/machines/) that grows and multiplies plants using
[water](https://minecraft.gamepedia.com/Water), [fertilizer](/docs/1.12/thermal-foundation-2/phyto-gro/)
...
[redprint](/docs/1.12/thermal-foundation-2/redprint/) to be copied to other insolators.
...
Phytogenic insolators come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
A phytogenic insolator can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve
