...
is a [machine](/docs/1.12/thermal-expansion-5/machines/) that refines fluids.
...
[redprint](/docs/1.12/thermal-foundation-2/redprint/) to be copied to other stills.


Tiers
-----

Fractionating stills come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
A fractionating still can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve
