...
A **redstone furnace** is a [machine](/docs/1.12/thermal-expansion-5/machines/) that
...
When installed, [pyrolytic conversion](/docs/1.12/thermal-expansion-5/augment-pyrolytic-conversion/)
makes a redstone furnace produce [creosote oil](/docs/1.12/thermal-foundation-2/creosote-oil/), which is
...
### Redprints
A redstone furnace's configuration can be saved on a [redprint](/docs/1.12/thermal-foundation-2/redprint/)
...
Redstone furnaces come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
A redstone furnace can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve
