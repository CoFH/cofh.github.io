...
An **enervation dynamo** is a [dynamo](/docs/1.12/thermal-expansion-5/dynamos/) that extracts [Redstone
...
Enervation dynamos come in six [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
An enervation dynamo can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve
