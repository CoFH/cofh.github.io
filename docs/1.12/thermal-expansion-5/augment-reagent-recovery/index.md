...
A **reagent recovery** [augment](/docs/1.12/thermal-expansion-5/augments/) provides a chance for an
[alchemical imbuer](/docs/1.12/thermal-expansion-5/alchemical-imbuer/) to not consume reagents
...
[alchemical imbuer](/docs/1.12/thermal-expansion-5/alchemical-imbuer/)'s GUI. It can be installed
multiple times, stacking its effects.

### Effects
Installed reagent recovery augments provide a chance for a [alchemical
imbuer](/docs/1.12/thermal-expansion-5/alchemical-imbuer/) to not consume a reagent
