...
other satchels or [strongboxes](/docs/1.12/thermal-expansion-5/strongbox/).
...
### Security
A satchel can have a [signalum security lock](/docs/1.12/thermal-foundation-2/signalum-security-lock/)
installed to restrict who can access it.

### Enchantments
A satchel can be enchanted with [Holding](/docs/1.12/cofh-core-4/holding/) to increase its
capacity.
