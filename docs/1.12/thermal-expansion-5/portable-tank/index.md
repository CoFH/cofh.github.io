...
### Configuration
A portable tank can be configured by using a [multimeter](/docs/1.12/thermal-foundation-2/multimeter/) on
...
transposer](/docs/1.12/thermal-expansion-5/fluid-transposer/). It can be used on placed portable tanks to
move fluids around. It can also be used to more quickly craft things that
require fluids to craft, like [signalum blend](/docs/1.12/thermal-foundation-2/signalum-blend/).
...
### Enchantments
A portable tank can be enchanted with [Holding](/docs/1.12/cofh-core-4/holding/) to increase its
capacity.
...
### Redprints
A portable tank's configuration can be saved on a [redprint](/docs/1.12/thermal-foundation-2/redprint/) to
...
Portable tanks come in six [tiers](/docs/1.12/thermal-foundation-2/tiers/).
