...
[machine](/docs/1.12/thermal-expansion-5/machines/) that charges items with [Redstone
...
augment](/docs/1.12/thermal-expansion-5/augment-flux-reconstruction/) allows an energetic infuser to
consume [essence of knowledge](/docs/1.12/thermal-foundation-2/essence-of-knowledge/), which is stored in
an added input tank.
...
[redprint](/docs/1.12/thermal-foundation-2/redprint/) to be copied to other energetic infusers.
...
Energetic infusers come in five [tiers](/docs/1.12/thermal-foundation-2/tiers/).
...
An energetic infuser can have [augments](/docs/1.12/thermal-expansion-5/augments/) installed to improve
