...
A **nutrient recovery** [augment](/docs/1.12/thermal-expansion-5/augments/) provides a chance for a
[phytogenic insolator](/docs/1.12/thermal-expansion-5/phytogenic-insolator/) to not consume fertilizer
([Phyto-Gro](/docs/1.12/thermal-foundation-2/phyto-gro/)).
...
[phytogenic insolator](/docs/1.12/thermal-expansion-5/phytogenic-insolator/)'s GUI. It can be installed
multiple times, stacking its effects.

### Effects
Installed nutrient recovery augments provide a chance for a [phytogenic
insolator](/docs/1.12/thermal-expansion-5/phytogenic-insolator/) to not consume a fertilizer item after
