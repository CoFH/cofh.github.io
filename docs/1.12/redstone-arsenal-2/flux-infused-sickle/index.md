...
A **flux-infused sickle** is a powerful [sickle](/docs/1.12/thermal-foundation-2/sickles/) powered by
...
(like regular [sickles](/docs/1.12/thermal-foundation-2/sickles/)), and consumes 200 RF per use. When
...
slightly higher than that of a [golden sickle](/docs/1.12/thermal-foundation-2/sickles/). It can
...
A flux-infused sickle can also be enchanted with [Holding](/docs/1.12/cofh-core-4/holding/) to
