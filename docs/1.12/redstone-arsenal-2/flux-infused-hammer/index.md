...
A **flux-infused hammer** is a powerful [hammer](/docs/1.12/thermal-foundation-2/hammers/) powered by
...
[diamond hammer](/docs/1.12/thermal-foundation-2/hammers/), breaks up to 9 blocks at a time in a 3x3
...
pickaxe](/docs/1.12/redstone-arsenal-2/flux-infused-pickaxe/) can harvest.
...
slightly higher than that of a [golden hammer](/docs/1.12/thermal-foundation-2/hammers/). It can
...
A flux-infused hammer can also be enchanted with [Holding](/docs/1.12/cofh-core-4/holding/) to
