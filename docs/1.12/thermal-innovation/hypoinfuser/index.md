...
injects [fluid potions](/docs/1.12/thermal-foundation-2/potion-fluid/).
...
A hypoinfuser can hold the [fluid form](/docs/1.12/thermal-foundation-2/potion-fluid/) or any regular
...
using a [fluid transposer](/docs/1.12/thermal-expansion-5/fluid-transposer/) or similar. It can also be
...
### Enchantments
A hypoinfuser can be enchanted with [Holding](/docs/1.12/cofh-core-4/holding/) to increase its
capacity.
...
Hypoinfusers come in six [tiers](/docs/1.12/thermal-foundation-2/tiers/).
