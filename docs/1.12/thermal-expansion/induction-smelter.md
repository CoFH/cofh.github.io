...
### General
{% include docs/recipe/table/table.html recipe-type='smelter' recipe-ids=page.recipe-list.general %}

### Ore processing
{% include docs/recipe/table/table.html recipe-type='smelter' recipe-ids=page.recipe-list.ore-processing %}

### Ore processing with rich slag
{% include docs/recipe/table/table.html recipe-type='smelter' recipe-ids=page.recipe-list.ore-processing-rich-slag %}

### Ore processing with cinnabar
{% include docs/recipe/table/table.html recipe-type='smelter' recipe-ids=page.recipe-list.ore-processing-cinnabar %}

### Alloying
{% include docs/recipe/table/table.html recipe-type='smelter' recipe-ids=page.recipe-list.alloying %}

### Recycling
{% include docs/recipe/table/table.html recipe-type='smelter' recipe-ids=page.recipe-list.recycling %}
