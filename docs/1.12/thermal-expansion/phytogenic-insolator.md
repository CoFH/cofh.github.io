...
### Using Phyto-Gro
{% include docs/recipe/table/table.html recipe-type='insolator' recipe-ids=page.recipe-list.phyto-gro %}

### Using rich Phyto-Gro
{% include docs/recipe/table/table.html recipe-type='insolator' recipe-ids=page.recipe-list.phyto-gro-rich %}

### Using fluxed Phyto-Gro
{% include docs/recipe/table/table.html recipe-type='insolator' recipe-ids=page.recipe-list.phyto-gro-fluxed %}
