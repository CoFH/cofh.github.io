...
[iron](https://minecraft.gamepedia.com/Iron_Ingot) and
[nickel](/docs/1.12/thermal-foundation-2/nickel-ingot/), either by crafting [invar
blend](/docs/1.12/thermal-foundation-2/invar-blend/) or by using an [induction
...
* If [Tinkers'
  ...
  molten [nickel](/docs/1.12/thermal-foundation-2/nickel-ingot/).
