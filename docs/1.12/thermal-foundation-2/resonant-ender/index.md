...
* If [Tinkers'
  ...
  installed, resonant ender can be mixed with molten [lead](/docs/1.12/thermal-foundation-2/lead-ingot/)
  and molten [platinum](/docs/1.12/thermal-foundation-2/platinum-ingot/) in a smeltery to make molten
