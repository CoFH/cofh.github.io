...
knowledge](/docs/1.12/thermal-foundation-2/essence-of-knowledge/) and vice versa. Each experience point is
...
### Enchantments
A tome of knowledge can be enchanted with [Holding](/docs/1.12/cofh-core-4/holding/) to increase
its capacity.
