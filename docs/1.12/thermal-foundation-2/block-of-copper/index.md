...
**Blocks of copper** are blocks made from [copper ingots](/docs/1.12/thermal-foundation-2/copper-ingot/).
...
### Storage
Blocks of copper can be used to store [copper ingots](/docs/1.12/thermal-foundation-2/copper-ingot/) in a
compact way.
