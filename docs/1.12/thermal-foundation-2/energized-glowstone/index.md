...
crucible](/docs/1.12/thermal-expansion-5/magma-crucible/). It is lighter than air and vertically flows up
instead of down.
...
### Natural generation
Deposits of [energized netherrack](/docs/1.12/thermal-foundation-2/energized-netherrack/) may contain some
...
cryotheum](/docs/1.12/thermal-foundation-2/gelid-cryotheum/), the source block instantly condenses back
...
* If [Tinkers'
  ...
  [tin](/docs/1.12/thermal-foundation-2/tin-ingot/) and molten [silver](/docs/1.12/thermal-foundation-2/silver-ingot/) in a smeltery
  to make molten [lumium](/docs/1.12/thermal-foundation-2/lumium-ingot/).
