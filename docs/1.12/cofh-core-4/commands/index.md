...
[CoFH Core](/docs/1.12/cofh-core-4/) adds various
...
| [friend](#friend) | Allows management of a player's [friend list](/docs/1.12/cofh-core-4/friend-list/). | -1 |
...
list](/docs/1.12/cofh-core-4/friend-list/). Can be done by either opening the friend
