...
surpassed by the [rich](/docs/1.12/thermal-foundation/rich-phyto-gro/) and
[fluxed](/docs/1.12/thermal-foundation/fluxed-phyto-gro/) versions.
...
### Arboreal Extractor
When Phyto-Gro is used in an [arboreal extractor](/docs/1.12/thermal-expansion/arboreal-extractor/), it
