...
**`stalactite`** is one of the [feature
types](/docs/cofh-world/world-generator-configuration/feature-types/) provided
by [CoFH World](/docs/cofh-world/). It generates downwards pointing spikes.
...
is only used to determine the position of stalactites. When generating the
stalactites themselves, the option `gen-body` is used instead.
...
{% include examples.html group="stalactite" primary=true %}
{% include examples.html group="stalactite" primary=false %}
