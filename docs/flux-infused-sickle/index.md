...
A **flux-infused sickle** is a powerful [sickle](/docs/sickles/) powered by
...
(like regular [sickles](/docs/sickles/)), and consumes 200 RF per use. When
...
slightly higher than that of a [golden sickle](/docs/sickles/). It can receive
all the enchantments that other sickles can receive.
